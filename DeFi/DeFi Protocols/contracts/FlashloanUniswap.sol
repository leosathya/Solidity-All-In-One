...
contract FlashloanUniswap is IUniswapV2Callee {
  // Uniswap V2 router
  ...
  function flashLoan(address _tokenToBorrow, uint _amount) external {
    address pair = IUniswapV2Factory(FACTORY).getPair(_tokenToBorrow, WETH);
